...
int main() {
    ...
    //я почитал интернет - это единственный способ обработать массив вводимой величины, не использу€ динамический vector
    //“ак как размер массива должен быть известен до компил€ции (видимо оно подстраиваетс€ дл€ создани€ такого размера
    //ещЄ во врем€ компил€ции)
